...
class Achievements {
	public static var achievementShits:Array<Dynamic> = [//Name, Description, Achievement save tag, Unlocks after, Hidden achievement
		...
		["Purgatory Master",		"Beat Till-Purgation Week Part 1 on Hard with no Misses.",				'week1_nomiss',			'weekEX', 		false],
		["WHAT..... HOW???????",				"Beat Till-Purgation Part 2 on Hard with no Misses.",				'week2_nomiss',         'weekEX2', 	
